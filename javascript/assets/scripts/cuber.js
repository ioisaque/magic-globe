(function () {
	...
	*/
    ...
    THREE.Sphere.prototype = {
        ...
        containsPoint: function (point) {
            return (
                point.distanceToSquared(this.center) <=
    ...
    THREE.Ray = function (origin, direction) {
        ...
        this.direction =
            direction !== undefined ? direction : new THREE.Vector3();
    };
    ...
    THREE.Ray.prototype = {
        ...
        intersectTriangle: (function () {
            ...
            return function (a, b, c, backfaceCulling, optionalTarget) {
                ...
                var DdQxE2 =
                    sign * this.direction.dot(edge2.crossVectors(diff, edge2));
    ...
    THREE.Plane = function (normal, constant) {
        this.normal =
            normal !== undefined ? normal : new THREE.Vector3(1, 0, 0);
    ...
    THREE.Plane.prototype = {
        ...
        applyMatrix4: (function () {
            ...
            return function (matrix, optionalNormalMatrix) {
                ...
                var normalMatrix =
                    optionalNormalMatrix || m1.getNormalMatrix(matrix);
        ...
        equals: function (plane) {
            return (
                plane.normal.equals(this.normal) &&
    ...
    THREE.CSS3DRenderer = function () {
        ...
        this.render = function (scene, camera) {
            ...
            var fov =
                (0.5 / Math.tan(THREE.Math.degToRad(camera.fov * 0.5))) *
                _height;
            ...
            document.getElementById("cube-state").innerHTML = cube.state.string;
            // }
        };
    };
    ...
    ERNO.extend(Number.prototype, {
        ...
        degreesToDirection: function () {
            ...
            return directions[
                this.scale(0, 360, 0, directions.length - 1).round()
            ];
        },
    ...
    ERNO.extend(String.prototype, {
        ...
        toCamelCase: function () {
            ...
            for (i = 1; i < split.length; i++) joined += split[i].capitalize();
        ...
        directionToDegrees: function () {
            ...
            return i >= 0
                ? i.scale(0, directions.length - 1, 0, 360)
                : Number.NaN;
        },
        toArray: function () {
            return [this];
	...
	*/
    ...
    ERNO.Direction.getDirectionByNormal = (function () {
        ...
        return function (normal) {
            ...
            return vector.equals(ERNO.Direction.FRONT.normal)
                ? ERNO.Direction.FRONT
                : vector.equals(ERNO.Direction.BACK.normal)
                ? ERNO.Direction.BACK
                : vector.equals(ERNO.Direction.UP.normal)
                ? ERNO.Direction.UP
                : vector.equals(ERNO.Direction.DOWN.normal)
                ? ERNO.Direction.DOWN
                : vector.equals(ERNO.Direction.LEFT.normal)
                ? ERNO.Direction.LEFT
                : vector.equals(ERNO.Direction.RIGHT.normal)
                ? ERNO.Direction.RIGHT
                : null;
        };
    })();
    ...
    ERNO.Direction.FRONT.setRelationships(
        ERNO.Direction.UP,
        ERNO.Direction.RIGHT,
        ERNO.Direction.DOWN,
        ERNO.Direction.LEFT,
    ...
    ERNO.Direction.UP.setRelationships(
        ERNO.Direction.BACK,
        ERNO.Direction.RIGHT,
        ERNO.Direction.FRONT,
        ERNO.Direction.LEFT,
    ...
    ERNO.Direction.RIGHT.setRelationships(
        ERNO.Direction.UP,
        ERNO.Direction.BACK,
        ERNO.Direction.DOWN,
        ERNO.Direction.FRONT,
    ...
    ERNO.Direction.DOWN.setRelationships(
        ERNO.Direction.FRONT,
        ERNO.Direction.RIGHT,
        ERNO.Direction.BACK,
        ERNO.Direction.LEFT,
    ...
    ERNO.Direction.LEFT.setRelationships(
        ERNO.Direction.UP,
        ERNO.Direction.FRONT,
        ERNO.Direction.DOWN,
        ERNO.Direction.BACK,
    ...
    ERNO.Direction.BACK.setRelationships(
        ERNO.Direction.UP,
        ERNO.Direction.LEFT,
        ERNO.Direction.DOWN,
        ERNO.Direction.RIGHT,
	...
	*/
    ...
    ERNO.Queue.prototype.purge = function () {
        ...
        if (elements instanceof Array) {
            elements.forEach(
                function (element) {
                    this.history = this.history.filter(function (
                        historyElement
                    ) {
	...
	*/
    ...
    ERNO.extend(ERNO.Cubelet.prototype, {
        ...
        setAddress: function (address) {
            ...
            this.addressY =
                address.modulo(9).divide(3).roundDown().subtract(1) * -1;
                ...
                if (this.radius !== radius) {
                    ...
                    new TWEEN.Tween(obj)
                        ...
                        .onUpdate(
                            function () {
                                this.position.set(
                                    this.addressX.multiply(
                                        this.size + obj.radius
                                    ) + 0.2,
                                    this.addressY.multiply(
                                        this.size + obj.radius
                                    ) + 0.2,
                                    this.addressZ.multiply(
                                        this.size + obj.radius
                                    ) + 0.2
                                );
                                this.updateMatrix();
	...
	*/
            ...
            return function (angle) {
                ...
                this.cubelets.forEach(function (cubelet) {
                    ...
                    cubelet.faces.forEach(function (face, index) {
                        ...
                        point.copy(
                            ERNO.Direction.getDirectionByName(face.normal)
                                .normal
                        );
                        ...
                        faceArray[
                            ERNO.Direction.getDirectionByNormal(point).id
                        ] = face;
                        face.normal =
                            ERNO.Direction.getDirectionByNormal(point).name;
                    });
    ...
    ERNO.extend(ERNO.Slice.prototype, {
        get origin() {
            return this.getCubelet(4);
        },
        get north() {
            return this.getCubelet(1);
        },
        get northEast() {
            return this.getCubelet(2);
        },
        get east() {
            return this.getCubelet(5);
        },
        get southEast() {
            return this.getCubelet(8);
        },
        get south() {
            return this.getCubelet(7);
        },
        get southWest() {
            return this.getCubelet(6);
        },
        get west() {
            return this.getCubelet(3);
        },
        get northWest() {
            return this.getCubelet(0);
        },
        ...
        map: function (indices, cubelets) {
            ...
            for (var i = 0; i < 6; i++) {
                if (
                    this.origin.faces[i].color &&
                    this.origin.faces[i].color !== ERNO.COLORLESS
                ) {
            ...
            if (this.axis === undefined || this.axis.lengthSq() === 0) {
                ...
                this.axis = new THREE.Vector3()
                    .crossVectors(pointB.sub(pointA), pointC.sub(pointA))
                    .normalize();
        ...
        set rotation(radians) {
            ...
            while (l--) {
                ...
                cubelet.matrix.multiplyMatrices(
                    this.matrix,
                    cubelet.matrixSlice
                );
	...
	*/
    ...
    ERNO.Projector = (function () {
        ...
        return function (cube, domElement) {
            ...
            function getFaceNormalForIntersection(
                intersection,
                optionalTarget
            ) {
            ...
            api = {
                getIntersection: function (
                    ...
                    mouseX,
                    mouseY,
                    optionalIntersectionTarget,
                    optionalPlaneTarget
                ) {
                    var intersection =
                        optionalIntersectionTarget || new THREE.Vector3();
                    ...
                    if (
                        ...
                        if (optionalPlaneTarget) {
                            ...
                            optionalPlaneTarget.setFromNormalAndCoplanarPoint(
                                normal,
                                intersection
                            );
                        }
                ...
                getCubeletAtIntersection: (function () {
                    ...
                    return function (intersection) {
                        ...
                        tmp.copy(intersection)
                            .add(box.max)
                            .multiplyScalar(3 / cube.size)
                            .set(
                                Math.min(tmp.x | 0, 2),
                                Math.min((3 - tmp.y) | 0, 2),
                                Math.min((3 - tmp.z) | 0, 2)
                            );
	...
	*/
        ...
        return function (cube, camera, domElement, dragSpeed, multiDrag) {
            ...
            api.getIntersectionAt = (function () {
                ...
                return function (x, y) {
                    ...
                    return {
                        cubelet:
                            projector.getCubeletAtIntersection(intersection3D),
                        face:
                            plane3D.normal.x === 1
                                ? "RIGHT"
                                : plane3D.normal.x === -1
            ...
            function snapVectorToBasis(vector) {
                ...
                vector.z =
                    vector.x === 1 || vector.y === 1 ? 0 : (vector.z / max) | 0;
            ...
            api.update = function () {
                ...
                if (
                    ...
                    projector.getIntersectionOnPlane(
                        camera,
                        x,
                        y,
                        plane,
                    ...
                    if (
                        !axisDefined &&
                        direction.length() >
                            5 /*|| ( api.multiDrag && direction.length() < api.multiDragSnapArea ) */
                    ) {
            ...
            function onInteractStart(event) {
                ...
                if (api.enabled && event.button !== 2) {
                    mouseX = ((event.touches && event.touches[0]) || event)
                        .clientX;
                    mouseY = ((event.touches && event.touches[0]) || event)
                        .clientY;
                    ...
                    if (
                        (intersected = projector.getIntersection(
                            camera,
                            mouseX,
                            mouseY,
                            intersection,
                        ...
                        if (cube.isTweening() === 0) {
                            ...
                            cubelet =
                                projector.getCubeletAtIntersection(
                                    intersection
                                );
            ...
            function onInteractEnd(event) {
                ...
                if (
                    ...
                    var targetAngle =
                        Math.round((angle / Math.PI) * 0.5 * 4.0) *
                        Math.PI *
                        0.5;
                    ...
                    if (velocityOfInteraction > 0.3) {
                        targetAngle =
                            Math.floor((angle / Math.PI) * 0.5 * 4.0) *
                            Math.PI *
                            0.5;
                        targetAngle +=
                            cross.dot(direction.normalize()) > 0
                                ? Math.PI * 0.5
                                : 0;
                    }
                    ...
                    cube.twist(
                        new ERNO.Twist(command, targetAngle.radiansToDegrees())
                    );
        ...
        return function (object, camera, domElement) {
            ...
            api.update = (function () {
                ...
                return function updateClosure() {
                    ...
                    direction.multiplyScalar(
                        1.0 - Math.max(0.0, Math.min(1.0, api.damping))
                    );
                    ...
                    object.object3D.rotateOnAxis(
                        axis,
                        -length * api.rotationSpeed
                    );
            ...
            function touchstart(event) {
                if (
                    ...
                    api.domElement.removeEventListener(
                        "touchstart",
                        touchstart
                    );
    ...
    ERNO.renderers.CSS3D = function (cubelets, cube) {
        ...
        ERNO.extend(
            ERNO.Cubelet.prototype,
            ERNO.renderers.CSS3DCubelet.methods
        );
    ...
    ERNO.renderers.CSS3DCubelet.methods = (function () {
        ...
        return {
            ...
            getFaceElements: function (selector) {
                ...
                return Array.prototype.slice.call(
                    this.css3DObject.element.querySelectorAll(
                        ".face" + selectorString
                    )
                );
            },
            ...
            setOpacity: function (opacityTarget, onComplete) {
                ...
                if (opacityTarget !== this.opacity) {
                    ...
                    this.opacityTween = new TWEEN.Tween({
                        ...
                        .onUpdate(function () {
                            that.css3DObject.element.style.opacity =
                                this.opacity;
            ...
            getStickersOpacity: function (value) {
                return parseFloat(
                    this.getFaceElements(" .sticker")[0].style.opacity
                );
            },
	...
	*/
    ...
    ERNO.Cube = function (parameters) {
        ...
        this.paused =
            parameters.paused === undefined ? false : parameters.paused;
        this.autoRotate =
            parameters.autoRotate === undefined ? false : parameters.autoRotate;
        this.keyboardControlsEnabled =
            parameters.keyboardControlsEnabled === undefined
                ? true
                : parameters.keyboardControlsEnabled;
        this.mouseControlsEnabled =
            parameters.mouseControlsEnabled === undefined
                ? true
        ...
        parameters.textureSize =
            parameters.textureSize === undefined ? 120 : parameters.textureSize;
        ...
        this.hideInvisibleFaces =
            parameters.hideInvisibleFaces === undefined
                ? false
        ...
        this.twistDuration =
            parameters.twistDuration !== undefined
                ? parameters.twistDuration
                : 500;
        ...
        [
            ...
            function (cubeletColorMap, cubeletId) {
                this.cubelets.push(
                    new ERNO.Cubelet(this, cubeletId, cubeletColorMap)
                );
            }.bind(this)
        );
        ...
        this.mouseInteraction = new ERNO.Interaction(
            this,
            this.camera,
            this.domElement
        );
        ...
        this.mouseInteraction.addEventListener(
            ...
            function (evt) {
                this.dispatchEvent(
                    new CustomEvent("click", { detail: evt.detail })
                );
            }.bind(this)
        );
        ...
        this.controls = new (parameters.controls || ERNO.Controls)(
            this,
            this.camera,
            this.domElement
        );
        ...
        this.state = {
            ...
            get: function () {
                ...
                ["U", "R", "F", "D", "L", "B"].forEach((face) => {
                    this.array[face].forEach((notation) => {
                        str += notation;
                    });
                });

                let spaced = str.match(/.{1,9}/g);
                this.string = spaced.join(" ");
            ...
            set: function (str) {
                if (str && str.length == 54)
                    for (var i = 0; i < 9; i++) {
                        this.array.U[i] = str.charAt(i);
                        this.array.R[i] = str.charAt(i + 9);
                        this.array.F[i] = str.charAt(i + 18);
                        this.array.D[i] = str.charAt(i + 27);
                        this.array.L[i] = str.charAt(i + 36);
                        this.array.B[i] = str.charAt(i + 45);
                    }
            },
        };
    };
    ...
    ERNO.extend(ERNO.Cube.prototype, {
        shuffle: function (amount, sequence) {
            ...
            var moves = this.shuffleMethod.slice(),
                move,
                inverseOfLastMove = new ERNO.Twist(),
                allowedMoves,
        ...
        solve: function () {
            ...
            const algorithm = document.getElementById("actionAlgorithm").value;

            if (algorithm)
                translateTwist(algorithm);
            else {
                // cubie = CubeJS.fromString(stateToString());
                // solution = cubie.solve();
                // if (solution) translateTwist(solution);
            }

            this.isSolving = false;
            document.getElementById("actionAlgorithm").value = '';
        },
        ...
        twist: function (command) {
            ...
            // this.magicTwist(command);

            this.addEventListener("onTwistComplete", function () {
                this.inspect();
                this.state.get();
            });
        },

        magicTwist: function (command) {
            let normTwist = "?",
                move = "?",
                wise = true,
                qMoves = 1;
            ...
            if (typeof command == "object") {
                ...
                wise = command.wise == "clockwise" ? true : false;
                qMoves = Math.abs(command.degrees / 90);
            } else {
                move = command;
                wise = move == move.toUpperCase() ? true : false;
            }

            move = move.toUpperCase();
            normTwist = wise ? move : move + "*";
        ...
        immediateTwist: function (twist) {
            ...
            var slice = this.slicesDictionary[twist.command.toLowerCase()],
                rotation =
                    (twist.degrees === undefined ? 90 : twist.degrees) *
                    twist.vector,
                radians = rotation.degreesToRadians(),
                duration =
                    (Math.abs(radians - slice.rotation) / (Math.PI * 0.5)) *
                    this.twistDuration;
        ...
        PRESERVE_LOGO: "RrLlUuDdBb", //  Preserve the logo position and rotation.
            ...
            return function () {
                ...
                if (!this.paused) {
                    ...
                    this.mouseInteraction.enabled =
                        this.mouseControlsEnabled && !this.finalShuffle;
